$(document).ready(function(){
	if($('.cfdebug').length) {
		...
		$('table.cfdebug:eq(0)')
			.wrap(function(i){return $('<div id="cfDebugOverlay">').css({position:"fixed", left:"0", top:"0", right:"0", bottom:"0", 'z-index':60000000, overflow:"auto", background:"white", display:"none", padding:"20px"});})
